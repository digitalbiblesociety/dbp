...
class NumbersController extends APIController
{
	...
	public function store(Request $request)
	{
		...
		foreach ($request->numerals as $input_numeral) {
			$alphabetExists = AlphabetNumber::where([['script_id',$input_numeral['script_id']], ['script_varient_iso',$input_numeral['script_varient_iso']], ['numeral',$input_numeral['numeral']], ['numeral_vernacular',$input_numeral['numeral_vernacular']], ['numeral_written',$input_numeral['numeral_written']]])->first();
