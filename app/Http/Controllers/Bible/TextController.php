...
class TextController extends APIController
{
    ...
    public function index($bible_url_param = null, $book_url_param = null, $chapter_url_param = null)
    {
        ...
        $cache_string = strtolower('bible_text:'.$asset_id.':'.$fileset_id.':'.$book_id.':'.$chapter.':'.$verse_start.':'.$verse_end);
        $verses = \Cache::remember($cache_string, 2400, function() use ($fileset,$bible,$book,$chapter,$verse_start,$verse_end) {
