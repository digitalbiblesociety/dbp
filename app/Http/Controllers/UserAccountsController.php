...
class UserAccountsController extends APIController
{
	 ...
	 *     @OAS\Parameter(name="project_id", in="query", description="The Project ID", required=true,
	 *          @OAS\Schema(ref="#/components/schemas/Project/properties/id")),
	 *     @OAS\Parameter(name="user_id", in="query", description="The User ID", required=true,
	 *          @OAS\Schema(ref="#/components/schemas/User/properties/id")),
	 ...
	 *     @OAS\Parameter(ref="#/components/parameters/pretty"),
	 *     @OAS\Parameter(ref="#/components/parameters/format"),
	 *     @OAS\RequestBody(required=true, description="Information supplied for user account creation",
