    ...
    */
	...
	public function reset(Request $request)
	{
		...
		$response = $this->broker()->reset(
			$this->credentials($request), function ($user, $password) { $this->resetPassword($user, $password); }
		);

		if ($this->api) {
			if ($response == Password::PASSWORD_RESET) return $this->reply(trans('passwords.reset'));
