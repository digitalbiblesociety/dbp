...
class UserHighlightsController extends APIController
{
    ...
    public function index($user_id)
    {
        ...
        $highlights = Highlight::with('color')->with('tags')->where('user_id', $user_id)
            ->join($dbp_database.'.bibles as bibles', 'bibles.id', '=', $dbp_database.'.user_highlights.bible_id')
     ...
     *     @OA\Parameter(name="user_id", in="path", @OA\Schema(ref="#/components/schemas/User/properties/id")),
     ...
     *     @OA\Parameter(name="user_id", in="path", @OA\Schema(ref="#/components/schemas/User/properties/id")),
     *     @OA\Parameter(name="highlight_id", in="path", @OA\Schema(ref="#/components/schemas/Highlight/properties/id")),
     *     @OA\Parameter(ref="#/components/parameters/version_number"),
     *     @OA\Parameter(ref="#/components/parameters/key"),
     *     @OA\Parameter(ref="#/components/parameters/pretty"),
     *     @OA\Parameter(ref="#/components/parameters/format"),
