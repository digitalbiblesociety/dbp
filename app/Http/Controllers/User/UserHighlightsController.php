...
class UserHighlightsController extends APIController
{
	 ...
	 *     @OA\Parameter(name="user_id",       in="path", description="The user who created the highlights", @OA\Schema(ref="#/components/schemas/User/properties/id")),
	 ...
	 *     @OA\Parameter(name="user_id", in="path", description="The user who created the highlights", @OA\Schema(ref="#/components/schemas/User/properties/id")),
	 *     @OA\Parameter(name="highlight_id", in="path", description="The highlight currently being altered", @OA\Schema(ref="#/components/schemas/Highlight/properties/id")),
	 *     @OA\Parameter(ref="#/components/parameters/version_number"),
	 *     @OA\Parameter(ref="#/components/parameters/key"),
	 *     @OA\Parameter(ref="#/components/parameters/pretty"),
	 *     @OA\Parameter(ref="#/components/parameters/format"),
