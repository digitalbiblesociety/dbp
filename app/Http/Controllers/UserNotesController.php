...
class UserNotesController extends APIController
{
	 ...
	 *              @OAS\Property(property="chapter",                   ref="#/components/schemas/Note/properties/chapter"),
	 *              @OAS\Property(property="verse_start",               ref="#/components/schemas/Note/properties/verse_start"),
	 *              @OAS\Property(property="notes",                     ref="#/components/schemas/Note/properties/notes"),
	 *              @OAS\Property(property="bookmark",                  ref="#/components/schemas/Note/properties/bookmark"),
	 *          )
	 *     )),
	 *     @OAS\Parameter(ref="#/components/parameters/version_number"),
	 *     @OAS\Parameter(ref="#/components/parameters/key"),
