...
// VERSION 4 | Stream
Route::name('v4_video_stream')->get('resources/jesus-films',                                  'Bible\VideoStreamController@jesusFilms');
Route::name('v4_video_stream')->get('resources/jesus-films/{iso}.m3u8',                       'Bible\VideoStreamController@jesusFilmStream');
