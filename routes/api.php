...
// VERSION 4 | Stream
Route::name('v4_video_stream')->get('stream/{fileset_id}/{file_id}/playlist.m3u8', 'Bible\VideoStreamController@index');
Route::name('v4_video_stream_ts')->get('stream/{fileset_id}/{file_id}/{file_name}','Bible\VideoStreamController@transportStream');
...
// VERSION 4 | Text
Route::name('v4_filesets.chapter')->get('text/{fileset_id}/{book}/{chapter}',      'Bible\TextController@index');
Route::name('v4_text_search')->get('test/search',                                  'Bible\TextController@search');
