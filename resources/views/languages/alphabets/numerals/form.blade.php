...
<fieldset class="text-center callout">
    ...
    <div class="equivalent-group">
        @if(isset($numbers))
            @foreach($numbers as $key => $number)
                <div class="row clonedInput" data-type="equivalent">
                    ...
                    <label class="medium-2 columns">Languages <input type="text" name="numerals[{{ $key }}][script_varient_iso]" list="languages" value="{{ $number->script_varient_iso }}"></label>
        ...
        <div class="row clonedInput" data-type="equivalent">
            ...
            <label class="medium-2 columns">Languages <input type="text" name="numerals[1][script_varient_iso]" list="languages"></label>
