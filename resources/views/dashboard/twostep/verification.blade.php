...
@section('title')
    {{ trans('laravel-verification.title') }}
@endsection

@php
switch ($remainingAttempts) {
    case 0:
    case 1: $remainingAttemptsClass = 'danger'; break;
    case 2: $remainingAttemptsClass = 'warning'; break;
    case 3: $remainingAttemptsClass = 'info'; break;
    default: $remainingAttemptsClass = 'success'; break;
}
@endphp
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel verification-form-panel">
                <div class="panel-heading text-center" id="verification_status_title">
                    <h3>{{ trans('laravel-verification.title') }}</h3>
                    <p class="text-center"><em>{{ trans('laravel-verification.subtitle') }}</em>
                    </p>
                </div>
                            ...
                            <div class="col-xs-3">
                                <div class="{{ $errors->has('v_input_1') ? ' has-error' : '' }}">
                                    <label for="v_input_1" class="sr-only control-label">
                                        {{ trans('laravel-verification.inputAlt1') }}
                                    </label>
                            ...
                            <div class="col-xs-3">
                                <div class="{{ $errors->has('v_input_2') ? ' has-error' : '' }}">
                                    <label for="v_input_2" class="sr-only control-label">
                                        {{ trans('laravel-verification.inputAlt2') }}
                                    </label>
                            ...
                            <div class="col-xs-3">
                                <div class="{{ $errors->has('v_input_3') ? ' has-error' : '' }}">
                                    <label for="v_input_3" class="sr-only control-label">
                                        {{ trans('laravel-verification.inputAlt3') }}
                                    </label>
                            ...
                            <div class="col-xs-3">
                                <div class="{{ $errors->has('v_input_4') ? ' has-error' : '' }}">
                                    <label for="v_input_4" class="sr-only control-label">
                                        {{ trans('laravel-verification.inputAlt4') }}
                                    </label>
                            ...
                            <div class="row">
                                <div class="col-xs-8 col-xs-offset-2 text-center submit-container">
                                    <button type="submit" class="btn btn-lg btn-{{ $remainingAttemptsClass }} btn-block" id="submit_verification" tabindex="5">
                                        ...
                                        {{ trans('laravel-verification.verifyButton') }}
                                    </button>
                                </div>
                                ...
                                <div class="col-xs-12 text-center">
                                    <a class="btn btn-link" id="resend_code_trigger" href="#" tabindex="6">
                                        {{ trans('laravel-verification.missingCode') }}
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    if (response.status === 418) {
                        ...
                        switch(remainingAttempts) {
                            case 0:
                                ...
                                swal(
                                  "{{ trans('laravel-verification.verificationLockedTitle') }}",
                                  "{{ trans('laravel-verification.verificationLockedMessage') }}",
                                  'error'
                                );
                                break;
                            ...
                            case 1:
                                submitTrigger.addClass('btn-danger');
                                swal(
                                  "{{ trans('laravel-verification.verificationWarningTitle') }}",
                                  "{{ trans('laravel-verification.verificationWarningMessage', ['hours' => $hoursToExpire, 'minutes' => $minutesToExpire,]) }}",
                                  'error'
                                );
                                break;
                        ...
                        if (remainingAttempts === 0) {
                            $('#verification_status_title').html('<h3>{{ trans('laravel-verification.titleFailed') }}</h3>');
        ...
        $("#resend_code_trigger").click(function(event) {
            ...
            function swalCallback(title, message, status) {
                swal({
                    ...
                    confirmButtonText: "{{ trans('laravel-verification.verificationModalConfBtn') }}",
                });
