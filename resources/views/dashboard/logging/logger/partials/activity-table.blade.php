    ...
    <table class="table">
            ...
            <tr>
                <th>
                    ...
                    <span class="hidden-sm hidden-xs">
                        @lang('dashboard.logger_labels_id')
                    </span>
                </th>
                <th>
                    <i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>
                    @lang('dashboard.logger_labels_time')
                </th>
                <th>
                    <i class="fa fa-file-text-o fa-fw" aria-hidden="true"></i>
                    @lang('dashboard.logger_labels_description')
                </th>
                <th>
                    <i class="fa fa-user-o fa-fw" aria-hidden="true"></i>
                    @lang('dashboard.logger_labels_user')
                </th>
                <th>
                    <i class="fa fa-truck fa-fw" aria-hidden="true"></i>
                    <span class="hidden-sm hidden-xs">
                        @lang('dashboard.logger_labels_method')
                    </span>
                </th>
                <th>
                    <i class="fa fa-map-o fa-fw" aria-hidden="true"></i>
                    @lang('dashboard.logger_labels_route')
                </th>
                <th>
                    <i class="fa fa-map-marker fa-fw" aria-hidden="true"></i>
                    @lang('dashboard.logger_labels_ipAddress')
                </th>
                <th>
                    <i class="fa fa-laptop fa-fw" aria-hidden="true"></i>
                    @lang('dashboard.logger_labels_agent')
                </th>
                @if(Request::is('activity/cleared'))
                    <th>
                        <i class="fa fa-trash-o fa-fw" aria-hidden="true"></i>
                        @lang('dashboard.logger_labels_deleteDate')
                    </th>
                @endif
            </tr>
        </thead>
        <tbody>
            @foreach($activities as $activity)
                <tr @if($drilldownStatus && $hoverable) class="clickable-row" data-href="{{$prependUrl . $activity->id}}" data-toggle="tooltip" title="{{trans('dashboard.tooltips.viewRecord')}}" @endif >
                    <td>
                        <small>
                            {{ $activity->id }}
                        </small>
                    ...
                    <td>
                        ...
                        <sup>
                            <small>{{ $browserVersion }}</small>
                        </sup>
                        <i class="fa {{ $platformIcon }} fa-fw" aria-hidden="true">
                            <span class="sr-only">{{ $platform }}</span>
                        </i>
                        <sup>
                            <small>{{ $activity->langDetails }}</small>
                        </sup>
                    </td>
                    @if(Request::is('activity/cleared'))
...
@if(config('LaravelLogger.loggerPaginationEnabled'))
    <div class="text-center">
        ...
        <p>
            @lang('dashboard.pagination.countText', ['firstItem' => $activities->firstItem(), 'lastItem' => $activities->lastItem(), 'total' => $activities->total(), 'perPage' => $activities->perPage()])
        </p>
    </div>
@endif
