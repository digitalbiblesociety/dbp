...
class BooksSeeder extends Seeder
{
    ...
    public function run()
    {
	    foreach (BookTranslation::all() as $translation) $translation->delete();
	    foreach (Book::all() as $book) $book->delete();

	    $seederhelper = new SeederHelper();
	    $books = $seederhelper->csv_to_array(storage_path() . "/data/bibles/books/books.csv");
	    Book::insert($books);

	    $codes = $seederhelper->csv_to_array(storage_path() . "/data/bibles/books/book_codes.csv");
	    BookCode::insert($codes);

	    $bookTranslations = $seederhelper->csv_to_array(storage_path() . "/data/bibles/books/book_translations.csv");
