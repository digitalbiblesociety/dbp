...
class CreateCountriesTables extends Migration
{
    ...
    public function up()
    {
	    ...
	    Schema::create('country_people', function (Blueprint $table) {
			...
			$table->decimal('age_structure_14', 4, 2)->unsigned()->nullable();                  // "Age structure" | "0-14 years"
		    $table->decimal('age_structure_24', 4, 2)->unsigned()->nullable();                  // "Age structure" | "15-24 years"
		    $table->decimal('age_structure_54', 4, 2)->unsigned()->nullable();                  // "Age structure" | "25-54 years"
		    $table->decimal('age_structure_64', 4, 2)->unsigned()->nullable();                  // "Age structure" | "55-64 years"
		    $table->decimal('age_structure_65', 4, 2)->unsigned()->nullable();                  // "Age structure" | "65 years and over"
			$table->decimal('dependency_total', 4, 2)->unsigned()->nullable();                  // "Dependency ratios" | "total dependency ratio"
            $table->decimal('dependency_youth', 4, 2)->unsigned()->nullable();                  // "Dependency ratios" | "youth dependency ratio"
            $table->decimal('dependency_elder', 4, 2)->unsigned()->nullable();                  // "Dependency ratios" | "elderly dependency ratio"
            $table->decimal('dependency_potential', 4, 2)->unsigned()->nullable();              // "Dependency ratios" | "potential support ratio"
			$table->decimal('median_age_total', 3, 2)->unsigned()->nullable();                  // "Median age" | "total"
		    $table->decimal('median_age_male', 3, 2)->unsigned()->nullable();                   // "Median age" | "male"
		    $table->decimal('median_age_female', 3, 2)->unsigned()->nullable();                 // "Median age" | "female"
	    ...
	    Schema::create('country_people_ethnicities', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
		    $table->string('name');
	    ...
	    Schema::create('country_religions', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
		    $table->string('name');
	    ...
	    Schema::create('country_government', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
	    ...
	    Schema::create('country_economy', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
	    ...
	    Schema::create('country_energy', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
	    ...
	    Schema::create('country_communications', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
	    ...
	    Schema::create('country_transportation', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
	    ...
	    Schema::create('country_issues', function (Blueprint $table) {
		    $table->char('country_id', 2);
		    $table->foreign('country_id')->references('id')->on('countries')->onUpdate('cascade');
    ...
    public function down()
    {
	    ...
	    Schema::dropIfExists('country_economy');
	    Schema::dropIfExists('country_religions');
	    Schema::dropIfExists('country_government');
	    Schema::dropIfExists('country_geography');
