...
class ApiV4Test extends TestCase
{
     ...
     * @category Route Path: https://api.dbp.test/connections/jesus-film/{iso}?v=4&key={key}
     ...
     * @category Route Path: https://api.dbp.test/connections/app/deeplinking?v=4&key={key}
     ...
     * @category Route Path: https://api.dbp.test/connections/grn/{iso}?v=4&key={key}
